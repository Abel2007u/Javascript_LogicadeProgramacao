alert("Compara dois valores e traz o maior - Desvio Cond. Composto²");
let N1 = parseInt(prompt("Por favor, insira o 1° número: "));
let N2 = parseInt(prompt("Por favor, insira o 2° e último número: "));

if (N1>N2) {
    alert("One win! O maior número¹ é: " + N1);
} else if (N1==N2) {
    alert("Os valores são iguais, tô de olho em! kkk teste-os sendo diferente.");
} else{
    alert("Two win! O maior número² é: " + N2);
}
